...
import { CURRENT_UPLOAD_IMAGE_VERSION } from './images.constant';
...
import { ImagePath } from './images.helper';
...
export class ImagesRepository {
  ...
  // async deletePermanentByIds(ids: string[], userId?: string): Promise<number> {
  //   const where = { id: ids };
  //   if (userId) {
  //     where['userId'] = userId;
  //   }
